...
public class PageUtil {
	...
	public static String generate(int page, int size, int length, String url) {
		...
		if (page > 1) {
			...
			header.append(url);
			header.append(pref);
			header.append("pageTag01=" + (page - 1));
			header.append("'>");
			header.append("Prev");
			header.append("</a>&nbsp;");
		}
		...
		if (currentPageCount < lastPageCount) {
			...
			header.append(url);
			header.append(pref);
			header.append("pageTag01=" + totalPage);
			header.append("'>");
			header.append("Last");
			header.append("</a>&nbsp;");
		}
	...
	public static void main(String args[]) {
		String pageTag=PageUtil.generate(1, 10, 3,"/Soyeon_Hotel/bookings.do");
