            		...
            		<div class="col-lg-4 col-md-6">
	                    <div class="room-item">
	                        ...
	                        <div class="ri-text">
	                            ...
	                            <a href="/Soyeon_Hotel/roomDetails.do?roomTypeCd=${room.roomTypeCd }&date_in=${requestScope.date_in}&date_out=${requestScope.date_out }&guest=${requestScope.guest}" class="primary-btn">More Details</a>
	                        </div>
	                    </div>
	                </div>
            	</c:forEach>
